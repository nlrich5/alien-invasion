...
class AlienInvasion:
    ...
    def _print_stats(self):
        ...
        self.score_text = self.font.render(f'Score: {self.stats.score}', True, (255, 255, 255))
        self.lives_text = self.font.render(f'Lives: {self.stats.ships_left}', True, (255, 255, 255))
        self.level_text = self.font.render(f'Level: {self.stats.level}', True, (255, 255, 255))

        # Draw 
        self.screen.blit(self.score_text, (10, 10))
        self.screen.blit(self.lives_text, (10, 50))
        self.screen.blit(self.level_text, (10, 90))
    ...
    def _level_up(self):
        self.stats.score += (self.stats.level * 100)
        self.stats.level += 1
